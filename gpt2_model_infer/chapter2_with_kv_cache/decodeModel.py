...
class DecodeModel(nn.Module):
    ...
    def forward(self, input_ids: torch.Tensor, kvCache):
        ...
        logger.info('self.lm_head(hidden_states)', hidden_states.shape)
        # 获取多语言头 
        ...
        logger.info('last_token_logits: ', last_token_logits.shape)
        ...
        logger.info('probabilities_np', probabilities_np)
