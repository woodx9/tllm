...
class PrefillModel(nn.Module):
    def __init__(self):
        ...
        self.h = nn.ModuleList([PrefillGPT2Block(self.config, self.modelParameters, layer_idx=i) for i in range(self.config.num_hidden_layers)])
...
class PrefillGPT2Block(nn.Module):
    def __init__(self, config, modelParameters, layer_idx=None):
        ...
        self.attn = PrefillGPT2Attention(config, modelParameters, layer_idx=layer_idx)
